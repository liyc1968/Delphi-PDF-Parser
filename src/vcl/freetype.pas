...
type
  ...
  (
   ...
   FT_StrokeBorder=^FT_StrokeBorderRec;
  FT_StrokeBorderRec=record
    ...
    tags:FT_Byte_ptr;
    movable:FT_Bool ;
    start:FT_Int;    //* index of current sub-path start point */
    memory:FT_Memory   ;
    valid:FT_Bool     ;
  ...
  FT_Library = ^FT_LibraryRec;
    ...
    FT_Stroker_ptr=^FT_Stroker;
  FT_Stroker=^FT_StrokerRec;
  FT_StrokerRec=record

    angle_in:FT_Angle    ;
    angle_out:FT_Angle   ;
    center:FT_Vector  ;
    first_point:FT_Bool  ;
    subpath_open:FT_Bool  ;
    ...
    valid:FT_Bool ;
    borders:array[0..1] of FT_StrokeBorderRec   ;
    library1:FT_Library   ;
  ...
  FT_Module_Requester = function(
      module: FT_Module;
      name: pChar): FT_Module_Interface; cdecl;
...
var
  ...
  FT_New_Face: function(
   ...
   FT_Get_Advance:function (face:FT_Face; gindex:FT_UInt;load_flags:FT_Int32;padvance:FT_Fixed_ptr):FT_Error; cdecl;
  (*************************************************************************)
  (*                                                                       *)
  (* <Function>                                                            *)
  (*    FT_New_Memory_Face                                                 *)
  ...
  *)
  ...
  FT_Get_Module: function(
      library_: FT_Library;
      module_name: pChar): FT_Module; cdecl;
 ...
 (**************************************************************
  ...
  FT_Outline_GetInsideBorder: function (outline:FT_Outline_ptr): FT_Error; cdecl;
   ...
   *   outlines.
   *)
  FT_Outline_GetOutsideBorder: function (outline:FT_Outline_ptr): FT_Error; cdecl;
  ...
  FT_Stroker_New: function (library1: FT_Library; astroker:FT_Stroker_ptr): FT_Error; cdecl;
  ...
  FT_Stroker_Set: procedure (stroker:FT_Stroker;radius:FT_Fixed;line_cap:FT_Stroker_LineCap;line_join:FT_Stroker_LineJoin;miter_limit:FT_Fixed); cdecl;
  (**************************************************************
   *
   * @function:
   *   FT_Stroker_Rewind
  ...
  FT_Stroker_Rewind: function (stroker:FT_Stroker): FT_Error; cdecl;
   ...
   *)
   ...
   FT_Stroker_ParseOutline: function (stroker:FT_Stroker;outline:FT_Outline_ptr;opened:FT_Bool): FT_Error; cdecl;
  (**************************************************************
   *
   * @function:
  ...
  FT_Stroker_BeginSubPath: function (stroker:FT_Stroker;to1:FT_Vector_ptr;open:FT_Bool): FT_Error; cdecl;
   ...
   *   @FT_Stroker_EndSubPath.
   *)
  FT_Stroker_LineTo: function (stroker:FT_Stroker;to1:FT_Vector_ptr): FT_Error; cdecl;
  ...
  FT_Stroker_ConicTo: function (stroker:FT_Stroker;control:FT_Vector_ptr; to1:FT_Vector_ptr): FT_Error; cdecl;
  ...
  FT_Stroker_CubicTo: function (stroker:FT_Stroker;control1:FT_Vector_ptr; contro2:FT_Vector_ptr;to1:FT_Vector_ptr): FT_Error; cdecl;
   ...
   *)
    ...
    FT_Stroker_GetBorderCounts: function (stroker:FT_Stroker;border:FT_StrokerBorder;anum_points:FT_UInt_ptr;anum_contours:FT_UInt_ptr ): FT_Error; cdecl;
  (**************************************************************
   *
   * @function:
  ...
  FT_Stroker_ExportBorder: function (stroker:FT_Stroker;border:FT_StrokerBorder;outline:FT_Outline_ptr ): FT_Error; cdecl;
  ...
  FT_Stroker_GetCounts: function (stroker:FT_Stroker;anum_points:FT_UInt_ptr;anum_contours:FT_UInt_ptr ): FT_Error; cdecl;
   ...
   *)
   ...
   FT_Stroker_Export: function (stroker:FT_Stroker;outline:FT_Outline_ptr ): FT_Error; cdecl;
  (**************************************************************
   *
   * @function:
   *   FT_Stroker_Done
   ...
   *)
   ...
   FT_Glyph_Stroke: function (pglyph:FT_Glyph_ptr; stroker:FT_Stroker;destroy:FT_Bool):FT_Error; cdecl;
  (**************************************************************
   *
   * @function:
  ...
  FT_Glyph_StrokeBorder: procedure (pglyph:FT_Glyph_ptr; stroker:FT_Stroker; inside:FT_Bool;destroy:FT_Bool); cdecl;


  FT_Get_X11_Font_Format: function( face:FT_Face   ):pchar;cdecl;
  (*
   * @macro:
   *   FT_LOAD_TARGET_MODE
   *
...
const
  ...
  function init_FreeType2(FreeType2_Name: String = FREETYPE2_NAME): boolean;
...
const
  ...
  function LoadLibrary(lpFileName: pChar): LongWord; stdcall; external Kernel32 name 'LoadLibraryA';
...
function GetProcAddr(Name: pChar): Pointer;
begin
  {$ifdef win32}
...
function init_FreeType2(FreeType2_Name: String): boolean;
var
  Temp: boolean;
begin
  if (FreeType2_RefCount = 0) or (FreeType2_Handle = {$ifdef win32} 0 {$else} nil {$endif}) then begin
    if FreeType2_Handle = {$ifdef win32} 0 {$else} nil {$endif} then
      {$ifdef win32}
        FreeType2_Handle := LoadLibrary(pchar(FreeType2_Name));
      {$else}
        FreeType2_Handle := dlopen(pchar(FreeType2_Name), RTLD_LAZY);
      {$endif}
    ...
    if FreeType2_Handle <> {$ifdef win32} 0 {$else} nil {$endif} then begin
      ...
      FT_Get_Advance:=GetProcAddr('FT_Get_Advance');
      FT_Get_X11_Font_Format:=GetProcAddr('FT_Get_X11_Font_Format');
      FT_Stroker_New:=GetProcAddr('FT_Stroker_New');
      FT_Stroker_Set:= GetProcAddr('FT_Stroker_Set');
      FT_Glyph_Stroke:=GetProcAddr('FT_Glyph_Stroke');
      FT_Stroker_Done:=GetProcAddr('FT_Stroker_Done');
    end;
  end;
